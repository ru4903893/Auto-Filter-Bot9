...
USERNAME = environ.get('USERNAME', 'https://telegram.me/Ordinary_Helper')
...
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/am.jpg')
...
VERIFY_IMG = environ.get("VERIFY_IMG", "https://files.catbox.moe/eyhv03.jpg")
